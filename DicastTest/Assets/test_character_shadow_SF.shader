...
////// Emissive:
                ...
                float3 emissive = (lerp( _GlowMax, (_GlowMin + ( (sin(node_9266.b) - node_7178) * (_GlowMax - _GlowMin) ) / (node_7042 - node_7178)), _Pulsation )*_SelfIllum_var.rgb);
